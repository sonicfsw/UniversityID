  ...
  return (
    <svg viewBox="0 0 1018 907" width="auto" height="auto">
      <g id="Audit">
        <g //207
          id="207"
          className={hoveredId === "207" ? "cls-207 highlighted" : "cls-207"}
          onMouseOver={() => handleMouseOver("207")}
          onMouseOut={handleMouseOut}
          onClick={() => handleClick("207")}
        >
          <path
            class="cls-1"
            d="M833.3,471.2h-92.7c-2.7,0-4.8,2.2-4.8,4.8v84.7c0,2.7,2.2,4.8,4.8,4.8h92.7c2.7,0,4.8-2.2,4.8-4.8V476C838.1,473.4,836,471.2,833.3,471.2z"
          />
          <text transform="matrix(1 0 0 1 768.662 524.8025)" class="cls-2">
            207
          </text>
        </g>
        ...
        <g //208
          id="208"
          className={hoveredId === "208" ? "cls-208 highlighted" : "cls-208"}
          onMouseOver={() => handleMouseOver("208")}
          onMouseOut={handleMouseOut}
          onClick={() => handleClick("208")}
        >
          <path
            class="cls-1"
            d="M659.1,422.5h-86.6c-2.7,0-4.8,2.2-4.8,4.8v63.1c0,2.7,2.2,4.8,4.8,4.8h86.6c2.7,0,4.8-2.2,4.8-4.8v-63.1C663.9,424.7,661.8,422.5,659.1,422.5z"
          />
          <text transform="matrix(1 0 0 1 595.4424 465.3349)" class="cls-2">
            208
          </text>
        </g>
        ...
        <g //209
          id="209"
          className={hoveredId === "209" ? "cls-209 highlighted" : "cls-209"}
          onMouseOver={() => handleMouseOver("209")}
          onMouseOut={handleMouseOut}
          onClick={() => handleClick("209")}
        >
          <path
            class="cls-1"
            d="M833.3,310.1h-92.7c-2.7,0-4.8,2.2-4.8,4.8v132.9c0,2.7,2.2,4.8,4.8,4.8h92.7c2.7,0,4.8-2.2,4.8-4.8V314.9C838.1,312.2,836,310.1,833.3,310.1z"
          />
          <text transform="matrix(1 0 0 1 768.1662 388.7905)" class="cls-2">
            209
          </text>
        </g>
        ...
        <g //210a
          id="210a"
          className={hoveredId === "210a" ? "cls-210a highlighted" : "cls-210a"}
          onMouseOver={() => handleMouseOver("210a")}
          onMouseOut={handleMouseOut}
          onClick={() => handleClick("210a")}
        >
          <path
            class="cls-1"
            d="M572.6,410.5h86.5c2.7,0,4.8-2.2,4.8-4.8v-35.2c0-2.7-2.2-4.8-4.8-4.8h-86.5c-2.7,0-4.8,2.2-4.8,4.8v35.2C567.8,408.4,570,410.5,572.6,410.5z"
          />
          <text transform="matrix(1 0 0 1 594.0664 395.31)" class="cls-2">
            210а
          </text>
        </g>
        ...
        <g //210b
          id="210b"
          className={hoveredId === "210b" ? "cls-210b highlighted" : "cls-210b"}
          onMouseOver={() => handleMouseOver("210b")}
          onMouseOut={handleMouseOut}
          onClick={() => handleClick("210b")}
        >
          <path
            class="cls-1"
            d="M659.1,313h-86.6c-2.7,0-4.8,2.2-4.8,4.8v32.7c0,2.7,2.2,4.8,4.8,4.8h86.6c2.7,0,4.8-2.2,4.8-4.8v-32.7C663.9,315.1,661.8,313,659.1,313z"
          />
          <text transform="matrix(1 0 0 1 594.4414 340.5139)" class="cls-2">
            210б
          </text>
        </g>
        ...
        <g //210v
          id="210v"
          className={hoveredId === "210v" ? "cls-210v highlighted" : "cls-210v"}
          onMouseOver={() => handleMouseOver("210v")}
          onMouseOut={handleMouseOut}
          onClick={() => handleClick("210v")}
        >
          <path
            class="cls-1"
            d="M659.1,259.6h-86.5c-2.7,0-4.8,2.2-4.8,4.8v33.5c0,2.7,2.2,4.8,4.8,4.8h86.5c2.7,0,4.8-2.2,4.8-4.8v-33.5C663.9,261.8,661.8,259.6,659.1,259.6z"
          />
          <text transform="matrix(1 0 0 1 594.4414 287.5529)" class="cls-2">
            210в
          </text>
        </g>
        ...
        <g //211
          id="211"
          className={hoveredId === "211" ? "cls-211 highlighted" : "cls-211"}
          onMouseOver={() => handleMouseOver("211")}
          onMouseOut={handleMouseOut}
          onClick={() => handleClick("211")}
        >
          <path
            class="cls-1"
            d="M833.3,160.9h-92.5c-2.7,0-4.8,2.2-4.8,4.8v119c0,2.7,2.2,4.8,4.8,4.8h92.5c2.7,0,4.8-2.2,4.8-4.8v-119C838.1,163.1,836,160.9,833.3,160.9z"
          />
          <text transform="matrix(1 0 0 1 773.2504 231.6244)" class="cls-2">
            211
          </text>
        </g>
        ...
        <g //212
          id="212"
          className={hoveredId === "212" ? "cls-212 highlighted" : "cls-212"}
          onMouseOver={() => handleMouseOver("212")}
          onMouseOut={handleMouseOut}
        >
          <path
            class="cls-1"
            d="M659.1,158.7h-86.6c-2.7,0-4.8,2.2-4.8,4.8V242c0,2.7,2.2,4.8,4.8,4.8h86.6c2.7,0,4.8-2.2,4.8-4.8v-78.5C663.9,160.8,661.8,158.7,659.1,158.7z"
          />
          <text transform="matrix(1 0 0 1 596.8125 209.1431)" class="cls-2">
            212
          </text>
        </g>
        ...
        <g //213
          id="213"
          className={hoveredId === "213" ? "cls-213 highlighted" : "cls-213"}
          onMouseOver={() => handleMouseOver("213")}
          onMouseOut={handleMouseOut}
          onClick={() => handleClick("213")}
        >
          <path
            class="cls-1"
            d="M834.1,102.4h-93.3c-2.7,0-4.8,2.2-4.8,4.8v33.4c0,2.7,2.2,4.8,4.8,4.8h93.3c2.7,0,4.8-2.2,4.8-4.8v-33.4C839,104.5,836.8,102.4,834.1,102.4z"
          />
          <text transform="matrix(1 0 0 1 773.2504 131.164)" class="cls-2">
            213
          </text>
        </g>
        ...
        <g //214
          id="214"
          className={hoveredId === "214" ? "cls-214 highlighted" : "cls-214"}
          onMouseOver={() => handleMouseOver("214")}
          onMouseOut={handleMouseOut}
          onClick={() => handleClick("214")}
        >
          <path
            class="cls-1"
            d="M659.1,56.9h-86.6c-2.7,0-4.8,2.2-4.8,4.8v76.9c0,2.7,2.2,4.8,4.8,4.8h86.6c2.7,0,4.8-2.2,4.8-4.8V61.7C663.9,59.1,661.8,56.9,659.1,56.9z"
          />
          <text transform="matrix(1 0 0 1 596.8125 105.8199)" class="cls-2">
            214
          </text>
        </g>
      ...
      <g id="Walls">
        ...
        <rect x="323.2" y="737.9" class="st7" width="5.5" height="109" />
        <rect x="176.1" y="737.9" class="st7" width="5.5" height="111.5" />
        <rect x="357.6" y="575.7" class="st7" width="5.4" height="107.5" />
        <rect x="269" y="573.5" class="st7" width="5.5" height="89.6" />
        <rect x="317.5" y="573.5" class="st7" width="5.5" height="89.6" />
        ...
        <rect x="559.6" y="251.7" class="st7" width="109.5" height="5.5" />
        <rect x="557.7" y="305.1" class="st7" width="89.8" height="5.5" />
        ...
        <rect x="557.7" y="499.4" class="st7" width="112.4" height="5.5" />
        ...
        <rect
          x="787.2"
          y="809.3"
          transform="matrix(0.7071 -0.7071 0.7071 0.7071 -338.73 805.8595)"
          class="st7"
          width="32.4"
          height="5.1"
        />
        ...
        />
        <g>
          <rect x="667.4" y="92.7" class="st7" width="5.5" height="19.9" />
          <rect x="667.4" y="49.5" class="st7" width="5.5" height="18.6" />
        </g>
        ...
        <rect x="221.5" y="735.1" class="st7" width="58" height="5.5" />
        <rect x="308" y="679.2" class="st7" width="97.1" height="5.5" />
        <rect x="304.5" y="735.1" class="st7" width="48" height="5.5" />
      ...
      <g
        id="Слой_1_00000179612626955273673980000002817507672044258980_"
        class="st9"
      ></g>
      <path
        class="st10"
        d="M664.3,702.5v125.9c0,6.4-5.2,11.6-11.6,11.6h-104v0.2H98.3c-6.4,0-11.6-5.2-11.6-11.6V702
	c0-6.4,5.2-11.6,11.6-11.6h80.5c6.4,0,11.6-5.2,11.6-11.6v-85.3c0-6.4,5.2-11.6,11.6-11.6h335c6.4,0,11.6,5.2,11.6,11.6v85.8
	c0,6.4,5.2,11.6,11.6,11.6h92.4C659.1,690.9,664.3,696.1,664.3,702.5z"
      />
      <text transform="matrix(1 0 0 1 311.7402 716.3546)" class="spec">
        IT-академия
      </text>
    </svg>
  );
